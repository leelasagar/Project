...
response = client.subscribe(
    TopicArn='arn:aws:sns:us-east-1:806167399263:my-test-topic',
    Protocol='email',
    Endpoint='sagar.g03@infosys.com',
    #ReturnSubscriptionArn=True
)
message = f"{k} \n Do not give reply"
#sending mail
response = client.publish(TopicArn='arn:aws:sns:us-east-1:806167399263:my-test-topic',Message=message)
print(response)
